import{L as g}from"./index-DbvRnEN1.js";function o(t){const e=document.createElement("div");return e.textContent=t??"",e.innerHTML}function b(t){return t?new Date(t).toLocaleDateString("en-IN",{day:"numeric",month:"long",year:"numeric"}):"—"}function l(t){const e=new URL(g,window.location.origin).href,i=(t.items||[]).map(n=>`
    <tr>
